...
presentations = [
  #OPEN WORLD-------------------------------------------------------------------------------------------------------------
    ...
    ("ow_multiplayer_choose_new_player", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ##DUMMY, CHANGE THIS IN EACH MOD
      ...
      (create_text_overlay, reg0, "str_ow_new_player_welcome", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (position_set_x, pos1, 0),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      (val_sub, ":cur_y", ow_menu_welcome_text_height),
      ...
      (create_button_overlay, "$g_presentation_obj_escape_menu_3", "str_ow_spawn", 0),
      (overlay_set_color, "$g_presentation_obj_escape_menu_3", 0xFFFFFF),
      (val_sub, ":cur_y", ow_menu_item_height),

      (create_button_overlay, "$g_presentation_obj_escape_menu_4", "str_quit", 0),
      ...
      (val_sub, ":cur_y", ow_menu_item_height),
      (try_begin),
        (ge, "$g_presentation_obj_escape_menu_4", 0),
        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_ow_multiplayer_troop_select"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_3"),
        (assign, "$g_presentation_state", 0),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_ow_multiplayer_spawn"),
      (else_try),
    ...
    ("ow_multiplayer_team_select", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
     ...
     [(store_trigger_param_1, ":object"),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (presentation_set_duration, 0),
          (start_presentation,"prsnt_ow_multiplayer_choose_new_player"),
        (else_try),
    ...
    ("ow_multiplayer_troop_select", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
    ...
    ("ow_multiplayer_spawn", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,[]),
    (ti_on_presentation_event_state_change,[]),
    (ti_on_presentation_run,[]),
    ]),
