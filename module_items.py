...
# Pistols
 # French
["french_cav_pistol", "French Pistol", [("french_cav_pistol",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(25),imodbits_none,
 []],
...
["french_pistol_1766", "Pistol", [("french_pistol_1766",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(25),imodbits_none,
 []],
#[(ti_on_weapon_attack, [(store_trigger_param_1,":user_agent"),(call_script, "script_server_fire_musket", ":user_agent", firearm_type_pistol)])]],
["french_pistol_1777", "French Pistol", [("flint_lock_pistol_1",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(25),imodbits_none,
 []],
#[(ti_on_weapon_attack, [(store_trigger_param_1,":user_agent"),(call_script, "script_server_fire_musket", ":user_agent", firearm_type_pistol)])]],
["french_pistol", "French Pistol", [("french_pistol",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(25),imodbits_none,
 []],
#[(ti_on_weapon_attack, [(store_trigger_param_1,":user_agent"),(call_script, "script_server_fire_musket", ":user_agent", firearm_type_pistol)])]],
["colonial_pistol", "Colonial Pistol", [("austrian_pistol",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(20),imodbits_none,
 []],
#[(ti_on_weapon_attack, [(store_trigger_param_1,":user_agent"),(call_script, "script_server_fire_musket", ":user_agent", firearm_type_pistol)])]],
["german_pistol", "German Pistol", [("spanish_cavalry_pistol",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(25),imodbits_none,
 []],
#[(ti_on_weapon_attack, [(store_trigger_param_1,":user_agent"),(call_script, "script_server_fire_musket", ":user_agent", firearm_type_pistol)])]],

 # Russian
["russian_pistol", "Mercenary Pistol", [("Russian_pistol",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(25),imodbits_none,
 []],
#[(ti_on_weapon_attack, [(store_trigger_param_1,":user_agent"),(call_script, "script_server_fire_musket", ":user_agent", firearm_type_pistol)])]],

 # British
["british_pistol", "British Pistol", [("new_land_pattern_pistol",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(25),imodbits_none,
 []],
["british_pistol_new", "British Pistol", [("english_dragoon_pistol",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(25),imodbits_none,
 []],
["old_pistol", "Old Pistol", [("potzdam_pistol",0)], itp_type_pistol|itp_merchandise|itp_primary|itp_cant_reload_while_moving_mounted ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left , 230 , weight(1.5)|difficulty(0)|spd_rtng(30) | shoot_speed(200) | thrust_damage(60 ,pierce)|max_ammo(1)|accuracy(35),imodbits_none,
 []],
...
683 , weight(3.0)|difficulty(0)|spd_rtng(27) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(65),imodbits_none,[]],
["cavalry_carbine", "Cavalry Carbine", [("hussar_carbine",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_while_moving_mounted|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.0)|difficulty(0)|spd_rtng(27) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(65),imodbits_none,[]],
["cavalry_carbine_melee", "Cavalry Carbine", [("hussar_carbine",0)], itp_has_upper_stab|itp_type_polearm |itp_primary|itp_no_blur|itp_offset_musket,itc_musket_melee|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(86) | weapon_length(76)|swing_damage(23 , blunt) | thrust_damage(12,  blunt),imodbits_none ],
...
683 , weight(3.0)|difficulty(0)|spd_rtng(25) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(72),imodbits_none,[]],
["long_rifle", "Longrifle", [("flintlock_rifle_1",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_while_moving_mounted|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.0)|difficulty(0)|spd_rtng(25) | shoot_speed(250) | thrust_damage(110 ,pierce)|max_ammo(1)|accuracy(93),imodbits_none,[]],
["long_rifle_melee", "Longrifle", [("flintlock_rifle_1",0)], itp_has_upper_stab|itp_type_polearm |itp_primary|itp_no_blur|itp_offset_musket,itc_musket_melee|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(86) | weapon_length(76)|swing_damage(23 , blunt) | thrust_damage(12,  blunt),imodbits_none ],
["1728_rifle", "1728 Rifle", [("model_1728",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_while_moving_mounted|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.0)|difficulty(0)|spd_rtng(25) | shoot_speed(250) | thrust_damage(107 ,pierce)|max_ammo(1)|accuracy(88),imodbits_none,[]],
["1728_rifle_melee", "1728 Rifle", [("model_1728",0)], itp_has_upper_stab|itp_type_polearm |itp_primary|itp_no_blur|itp_offset_musket,itc_musket_melee|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(86) | weapon_length(76)|swing_damage(23 , blunt) | thrust_damage(12,  blunt),imodbits_none ],
["charleville_modele_1777", "Charleville Modele 1777", [("charleville",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_while_moving_mounted|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.0)|difficulty(0)|spd_rtng(25) | shoot_speed(250) | thrust_damage(105 ,pierce)|max_ammo(1)|accuracy(85),imodbits_none,[]],
["charleville_modele_1777_melee", "Charleville Modele 1777", [("charleville",0)], itp_has_upper_stab|itp_type_polearm |itp_primary|itp_no_blur|itp_offset_musket,itc_musket_melee|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(86) | weapon_length(76)|swing_damage(23 , blunt) | thrust_damage(12,  blunt),imodbits_none ],
...
683 , weight(3.0)|difficulty(0)|spd_rtng(27) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(65),imodbits_none,[]],
["highlander_rifle", "Highlander Rifle", [("long_land_pattern",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_while_moving_mounted|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.0)|difficulty(0)|spd_rtng(27) | shoot_speed(250) | thrust_damage(103 ,pierce)|max_ammo(1)|accuracy(80),imodbits_none,[]],
["highlander_rifle_melee", "Highlander Rifle", [("long_land_pattern",0)], itp_has_upper_stab|itp_type_polearm |itp_primary|itp_no_blur|itp_offset_musket,itc_musket_melee|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(86) | weapon_length(50)|swing_damage(23 , blunt) | thrust_damage(12,  blunt),imodbits_none ],
["old_rifle", "Old Rifle", [("matchlock_2",0)], itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_while_moving_mounted|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.0)|difficulty(0)|spd_rtng(25) | shoot_speed(250) | thrust_damage(75 ,pierce)|max_ammo(1)|accuracy(85),imodbits_none,[]],
["old_rifle_melee", "Old Rifle", [("matchlock_2",0)], itp_has_upper_stab|itp_type_polearm |itp_primary|itp_no_blur|itp_offset_musket,itc_musket_melee|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(86) | weapon_length(76)|swing_damage(23 , blunt) | thrust_damage(12,  blunt),imodbits_none ],
...
#Muskets
# French
["french_charleville", "French Infantry Musket", [("french_charleville",0)], itp_cant_use_on_horseback|itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_on_horseback|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
...
["french_charleville_melee", "French Infantry Musket", [("french_charleville",0)], itp_cant_use_on_horseback|itp_has_upper_stab|itp_type_polearm |itp_primary|itp_is_pike|itp_no_blur,itc_spear|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(85) | weapon_length(138)|swing_damage(40 ,  pierce) | thrust_damage(45 ,  pierce),imodbits_none ],
["french_versailles", "French Infantry Musket", [("french_versailles",0)], itp_cant_use_on_horseback|itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_on_horseback|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.5)|difficulty(0)|spd_rtng(23) | shoot_speed(250) | thrust_damage(104 ,pierce)|max_ammo(1)|accuracy(78),imodbits_none,[]],
# [(ti_on_weapon_attack, [(store_trigger_param_1,":user_agent"),(call_script, "script_server_fire_musket", ":user_agent", firearm_type_musket),])]],
["french_versailles_melee", "French Infantry Musket", [("french_versailles",0)], itp_cant_use_on_horseback|itp_has_upper_stab|itp_type_polearm |itp_primary|itp_is_pike|itp_no_blur,itc_spear|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(85) | weapon_length(138)|swing_damage(45 ,  pierce) | thrust_damage(50 ,  pierce),imodbits_none ],
["german_musket", "German Infantry Musket", [("prussian_musket_bayonet",0)], itp_cant_use_on_horseback|itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_on_horseback|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.5)|difficulty(0)|spd_rtng(23) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(77),imodbits_none,[]],
# [(ti_on_weapon_attack, [(store_trigger_param_1,":user_agent"),(call_script, "script_server_fire_musket", ":user_agent", firearm_type_musket),])]],
["german_musket_melee", "German Infantry Musket", [("prussian_musket_bayonet",0)], itp_cant_use_on_horseback|itp_has_upper_stab|itp_type_polearm |itp_primary|itp_is_pike|itp_no_blur,itc_spear|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(85) | weapon_length(138)|swing_damage(40 ,  pierce) | thrust_damage(45 ,  pierce),imodbits_none ],
["bow", "Bow", [("bow_test",0),("war_bow_carry",ixmesh_carry)],itp_type_bow|itp_merchandise|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back, 728 , weight(1.5)|difficulty(1)|spd_rtng(93) | shoot_speed(58) | thrust_damage(40 ,pierce),imodbits_bow ],

# British
["british_brown_bess", "British Infantry Musket", [("brown_bess_musket",0)], itp_cant_use_on_horseback|itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_on_horseback|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.5)|difficulty(0)|spd_rtng(23) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(75),imodbits_none,[]],
["british_brown_bess_melee", "British Infantry Musket", [("brown_bess_musket",0)], itp_cant_use_on_horseback|itp_has_upper_stab|itp_type_polearm |itp_primary|itp_is_pike|itp_no_blur,itc_spear|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(85) | weapon_length(136)|swing_damage(40 ,  pierce) | thrust_damage(45 ,  pierce),imodbits_none ],
["infantry_musket", "Infantry Musket", [("short_land_pattern_bayonet",0)], itp_cant_use_on_horseback|itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_on_horseback|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.5)|difficulty(0)|spd_rtng(23) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(72),imodbits_none,[]],
["infantry_musket_melee", "Infantry Musket", [("short_land_pattern_bayonet",0)], itp_cant_use_on_horseback|itp_has_upper_stab|itp_type_polearm |itp_primary|itp_is_pike|itp_no_blur,itc_spear|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(85) | weapon_length(136)|swing_damage(40 ,  pierce) | thrust_damage(45 ,  pierce),imodbits_none ],
["colonial_musket", "Colonial Musket", [("prussian_dragoon_carbine_bayonet",0)], itp_cant_use_on_horseback|itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_on_horseback|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.5)|difficulty(0)|spd_rtng(23) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(69),imodbits_none,[]],
["colonial_musket_melee", "Colonial Musket", [("prussian_dragoon_carbine_bayonet",0)], itp_cant_use_on_horseback|itp_has_upper_stab|itp_type_polearm |itp_primary|itp_is_pike|itp_no_blur,itc_spear|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(85) | weapon_length(136)|swing_damage(40 ,  pierce) | thrust_damage(45 ,  pierce),imodbits_none ],
["carbine", "Carbine", [("charleville_carbine_bayonet",0)], itp_cant_use_on_horseback|itp_type_crossbow |itp_merchandise|itp_primary|itp_two_handed|itp_cant_reload_on_horseback|itp_cant_reload_while_moving|itp_next_item_as_melee ,itcf_shoot_musket|itcf_carry_crossbow_back, 
683 , weight(3.5)|difficulty(0)|spd_rtng(23) | shoot_speed(250) | thrust_damage(100 ,pierce)|max_ammo(1)|accuracy(80),imodbits_none,[]],
["carbine_melee", "Carbine", [("charleville_carbine_bayonet",0)], itp_cant_use_on_horseback|itp_has_upper_stab|itp_type_polearm |itp_primary|itp_is_pike|itp_no_blur,itc_spear|itcf_carry_crossbow_back,
180 , weight(0)|difficulty(0)|spd_rtng(85) | weapon_length(136)|swing_damage(40 ,  pierce) | thrust_damage(45 ,  pierce),imodbits_none ],
...
210 , weight(3.0)|difficulty(0)|spd_rtng(91) | weapon_length(110)|swing_damage(36 , cut) | thrust_damage(32 ,  pierce),imodbits_sword_high ],
 ["french_briquet_garde","Grenadier Sword", [("Garde_briquet",0),("Guard_briquet_in_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
210 , weight(1.6)|difficulty(0)|spd_rtng(95) | weapon_length(80)|swing_damage(25 , cut) | thrust_damage(23 ,  pierce),imodbits_sword_high ],
...
210 , weight(3.0)|difficulty(0)|spd_rtng(91) | weapon_length(112)|swing_damage(36 , cut) | thrust_damage(32 ,  pierce),imodbits_sword_high ],
 ["french_inf_off_sabre","French Officer Sabre", [("Infantry_officer_sword",0),("Infantry_officer_sword_in_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
...
210 , weight(1.2)|difficulty(0)|spd_rtng(95) | weapon_length(72)|swing_damage(22 , cut) | thrust_damage(20 ,  pierce),imodbits_sword_high ],
 ["french_grenadier_hanger","French Grenadier Hanger", [("french_grenadier_hanger",0),("Sabre_briquet_in_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
210 , weight(1.2)|difficulty(0)|spd_rtng(95) | weapon_length(63)|swing_damage(22 , cut) | thrust_damage(20 ,  pierce),imodbits_sword_high ],
 ["french_voyageurs_off_sword","German Officer Sword", [("german_dragoon_sword",0),("Line_cav_ANXIII_in_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
210 , weight(1.5)|difficulty(0)|spd_rtng(96) | weapon_length(109)|swing_damage(34 , cut) | thrust_damage(31 ,  pierce),imodbits_sword_high ],
 ["french_colonial_off_sword","French Colonial Sword", [("spanish_dragoon_sword",0),("spanish_dragoon_sword_in_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
210 , weight(1.5)|difficulty(0)|spd_rtng(100) | weapon_length(100)|swing_damage(30 , cut) | thrust_damage(27 ,  pierce),imodbits_sword_high ],
 ["iron_tomahawk","Iron Tomahawk", [("Russian_peasant_axe",0)], itp_type_thrown|itp_merchandise|itp_next_item_as_melee,itcf_throw_axe,
360, weight(1)|difficulty(0)|spd_rtng(90) | shoot_speed(16) | thrust_damage(45,cut)|max_ammo(3)|weapon_length(40),imodbits_none,
[(ti_on_missile_hit, [(this_or_next|multiplayer_is_server),(neg|game_in_multiplayer_mode),(copy_position,pos56,pos1),(call_script,"script_multiplayer_server_play_sound_at_position","snd_glass_break"),])]],
 ["iron_tomahawk_melee", "Iron Tomahawk", [("Russian_peasant_axe",0)], itp_type_one_handed_wpn|itp_merchandise| itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_sword_left_hip,
100 , weight(1.5)|difficulty(0)|spd_rtng(95) | weapon_length(80)|swing_damage(33 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
...
210 , weight(1.2)|difficulty(0)|spd_rtng(95) | weapon_length(63)|swing_damage(22 , cut) | thrust_damage(20 ,  pierce),imodbits_sword_high ],
 ["russian_officer_sword","Mercenary Officer Sword", [("Russian_officer_sword",0),("Russian_officer_sword_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
210 , weight(1.5)|difficulty(0)|spd_rtng(95) | weapon_length(100)|swing_damage(33 , cut) | thrust_damage(30 ,  pierce),imodbits_sword_high ],
...
210 , weight(1.5)|difficulty(0)|spd_rtng(95) | weapon_length(109)|swing_damage(34 , cut) | thrust_damage(31 ,  pierce),imodbits_sword_high ],
...
210 , weight(2.0)|difficulty(0)|spd_rtng(93) | weapon_length(101)|swing_damage(33 , cut) | thrust_damage(30 ,  pierce),imodbits_sword_high ], 
 ["british_baker_bayonet","Infantry Sword", [("British_baker_bayonet",0),("British_baker_bayonet_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
210 , weight(1.2)|difficulty(0)|spd_rtng(95) | weapon_length(63)|swing_damage(22 , cut) | thrust_damage(20 ,  pierce),imodbits_sword_high ],
...
210 , weight(1.5)|difficulty(0)|spd_rtng(95) | weapon_length(100)|swing_damage(32 , cut) | thrust_damage(29 ,  pierce),imodbits_sword_high ],
 ["highlander_broadsword","Highlander Sword", [("scottish_broadsword",0),("scottish_broadsword_in_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
210 , weight(1.5)|difficulty(0)|spd_rtng(97) | weapon_length(110)|swing_damage(35 , cut) | thrust_damage(32 ,  pierce),imodbits_sword_high ],
["british_colonial_off_sword","British Colonial Sword", [("Line_cav_ANXIII",0),("Line_cav_ANXIII_in_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 
210 , weight(1.5)|difficulty(0)|spd_rtng(92) | weapon_length(106)|swing_damage(31 , cut) | thrust_damage(28 ,  pierce),imodbits_sword_high ],
...
["pistol_ammo","Cartridges", [("cartridge_box_mesh",0),("bullet_projectile",ixmesh_flying_ammo),("cartridge_a",ixmesh_inventory)], itp_type_bullets|itp_merchandise|itp_can_penetrate_shield, 0, 200,weight(1.0)|abundance(100)|weapon_length(1)|thrust_damage(1,pierce)|max_ammo(18),imodbits_missile,
 [(ti_on_missile_hit, [(copy_position,pos63,pos1),(store_trigger_param_2, ":collision_type"),(call_script, "script_mm_on_bullet_hit",":collision_type")])]],
["arrows","Arrows", [("bronze_arrow",0),("bronze_arrow_flying",ixmesh_flying_ammo),("quiver_bronze",ixmesh_inventory)], itp_type_arrows|itp_merchandise, itcf_carry_quiver_back_right, 410,weight(3.5)|abundance(30)|weapon_length(95)|thrust_damage(3,pierce)|max_ammo(30),imodbits_missile],
...
["halberd", "Halberd", [("spontoon_new",0)], itp_type_polearm|itp_merchandise| itp_cant_use_on_horseback|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_two_handed|itp_is_pike|itp_no_blur, itc_staff,
 125 , weight(3.3)|difficulty(0)|spd_rtng(80) | weapon_length(190)|swing_damage(23 , cut) | thrust_damage(38, pierce),imodbits_polearm ],
["hurons_warrior_axe", "Warrior Axe", [("hurons_warrior_axe",0)], itp_type_one_handed_wpn|itp_merchandise| itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_sword_left_hip,
 125 , weight(2.3)|difficulty(9)|spd_rtng(100) | weapon_length(105)|swing_damage(25 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["iroquois_warrior_axe", "Warrior Axe", [("iroquois_warrior_axe",0)], itp_type_one_handed_wpn|itp_merchandise| itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_sword_left_hip,
 125 , weight(2.3)|difficulty(9)|spd_rtng(100) | weapon_length(105)|swing_damage(25 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["war_chief_axe", "War Chief Axe", [("war_chief_axe",0)], itp_type_polearm|itp_merchandise| itp_cant_use_on_horseback|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_two_handed|itp_no_blur, itc_parry_polearm|itc_cut_two_handed,
 125 , weight(3.5)|difficulty(0)|spd_rtng(77) | weapon_length(110)|swing_damage(33 , cut) | thrust_damage(0, pierce),imodbits_polearm ],
["war_axe", "War Axe", [("war_axe",0)], itp_type_one_handed_wpn|itp_merchandise| itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_sword_left_hip,
 125 , weight(2.3)|difficulty(9)|spd_rtng(90) | weapon_length(88)|swing_damage(31 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["casse_tete", "Casse-tete", [("mace",0)], itp_type_one_handed_wpn|itp_merchandise| itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_sword_left_hip,
 125 , weight(3.5)|difficulty(9)|spd_rtng(99) | weapon_length(103)|swing_damage(20 , blunt) | thrust_damage(0 ,  pierce),imodbits_axe ],
["french_axe", "French Axe", [("french_axe",0)], itp_type_polearm|itp_merchandise| itp_cant_use_on_horseback|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_two_handed|itp_no_blur, itc_parry_polearm|itc_cut_two_handed,
 125 , weight(2.7)|difficulty(0)|spd_rtng(85) | weapon_length(85)|swing_damage(30 , cut) | thrust_damage(0, pierce),imodbits_polearm ],
["hurons_spear", "Hurons Spear", [("hurons_spear",0)], itp_has_upper_stab|itp_type_polearm|itp_merchandise| itp_cant_use_on_horseback|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_two_handed|itp_is_pike|itp_no_blur, itc_spear,
 125 , weight(2.7)|difficulty(0)|spd_rtng(76) | weapon_length(190)|swing_damage(27 , pierce) | thrust_damage(32, pierce),imodbits_polearm ],
...
["french_bavarian_inf_flutist", "Vistula Legion Uniform", [("bavarian_inf_flutist",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["french_bourgogne_uniform", "French Bourgogne Uniform", [("french_bourgogne_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["french_bourgogne_officer_uniform", "French Bourgogne Officer Uniform", [("french_bourgogne_officer_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["french_guyenne_uniform", "French Guyenne Uniform", [("french_guyenne_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["french_la_sarre_uniform", "French La Sarre Uniform", [("french_la_sarre_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["french_la_sarre_officer_uniform", "French La Sarre Officer Uniform", [("french_la_sarre_officer_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["french_la_reine_uniform", "French La Reine Uniform", [("french_guyenne_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["french_languedoc_uniform", "French Languedoc Uniform", [("french_languedoc_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["french_volontaires_etrangers_uniform", "French Volontaires Etrangers Uniform", [("french_volontaires_etrangers_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
...
["naked_male_body", "naked_male_body", [("0",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["british_roger_ranger_uniform", "british_roger_ranger_uniform", [("british_roger_ranger_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
["british_47th_uniform", "british_47th_uniform", [("british_47th_uniform",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs |itp_civilian,0,
 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(14)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
...
["french_tricorne_whitelace", "tricorne_withelace", [("tricorne_withelace_nocockade",0)], itp_merchandise| itp_type_head_armor |itp_civilian|itp_doesnt_cover_hair  ,0, 4 , weight(0.5)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["french_tricorne_goldlace", "tricorne_goldlace", [("tricorne_goldlace_nocockade",0)], itp_merchandise| itp_type_head_armor |itp_civilian|itp_doesnt_cover_hair  ,0, 4 , weight(0.5)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["french_tricorne_whitelace_cockade_black", "tricorne_withelace_cockade_black", [("tricorne_withelace_cockade_black",0)], itp_merchandise| itp_type_head_armor |itp_civilian|itp_doesnt_cover_hair  ,0, 4 , weight(0.5)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["french_tricorne_goldlace_cockade_black", "tricorne_goldlace_cockade_black", [("tricorne_goldlace_cockade_black",0)], itp_merchandise| itp_type_head_armor |itp_civilian|itp_doesnt_cover_hair  ,0, 4 , weight(0.5)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
...
#Boots
 ...
 10 , weight(1.25)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(30)|difficulty(0) ,imodbits_cloth ],
 ["french_white_officer_boots", "French Officer White Boots", [("white_officer_boots",0)], itp_merchandise| itp_type_foot_armor  |itp_civilian | itp_attach_armature,0,
 10 , weight(1.25)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(30)|difficulty(0) ,imodbits_cloth ],
 ["white_boots", "White Boots", [("white_boots",0)], itp_merchandise| itp_type_foot_armor  |itp_civilian | itp_attach_armature,0,
 10 , weight(1.25)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(30)|difficulty(0) ,imodbits_cloth ],
